...
<div class="container" style="width:1500px;margin-left:10px;">
  ...
  <div class="panel panel-default" style="width:100%;background-color: #e9e9e9;border: 1px solid #d2d2d2;">
    <div>
    <h4 style="margin-left: 10px;margin-top: 15px;"><b>Detail Timesheet Report</b></h4>
    </div>
  ...
  <button onClick="location.href='detail_generate_report.php'" data-toggle="modal" data-target="#save" type="button" class="btn btn-info"><i class="fa fa-edit">Generate Report</i></button>
 </div>
...
<hr>
    ...
    <span></span> <i class="fa fa-caret-down"></i>
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Developers:</h6></label>
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Clients:</h6></label>
        <select  class="selectpicker"  multiple data-live-search="true" class="checkbox" data-size="5">
      <option value="">CIPLA Pharmaceuticals Pvt Ltd</option>
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Projects:</h6></label>
        <select  class="selectpicker"  multiple data-live-search="true" class="checkbox" data-size="5">
      <option value="">Air Travel</option>
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Project Tasks:</h6></label>
       <select disabled=""  class="selectpicker"  multiple data-live-search="true" class="checkbox" data-size="5">
      <option value="">Air Travel</option>
        </select>
      </div>
      <div class="col-xs-2">
...
<div class="form-group row">
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Project Type:</h6></label>
        <select class="selectpicker" multiple data-live-search="true" class="checkbox" data-size="5">
      <option value="active">Marketing</option>
      <option value="1">Technology</option>
      <option value="active">Training</option>
  </select>
      </div>
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Employee Type:</h6></label>
        <select class="selectpicker" multiple data-live-search="true" class="checkbox" data-size="5">
      <option value="1">Administrator</option>
      <option value="2">Consultant</option>
      <option value="3">Not Constructor</option>
      <option value="4">Full-time Hourly</option>
      <option value="5">Full-time Salaried</option>
      <option value="6">Part-time Hourly</option>
      <option value="7">Part-time Salaried</option>
      </select>

      </div>
       <div class="form-group row">
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Work Type:</h6></label>
        <select class="selectpicker"  multiple data-live-search="true" class="checkbox" data-size="5">
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Cost Center:</h6></label>
        <select class="selectpicker"  multiple data-live-search="true" class="checkbox" data-size="5">
...
<div class="form-group row">
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Billing Type:</h6></label>
        <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="type">
      <option value="active">Both</option>
       <option value="1">Billable</option>
             <option value="active">Non-Billable</option>
      ...
      <option value="active">Both</option>
       ...
       <div class="form-group row">
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Billed:</h6></label>
        <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="type">
      <option value="active">Both</option>
       <option value="1">Billed</option>
             <option value="active">Not Billed</option>
      ...
      <div class="col-xs-2">
         <label for="ex1" style="color: black;"><h6>Timesheet Type:</h6></label>
         <select class="selectpicker" data-show-subtext="true" data-live-search="true" id="type">
      <option value="active">Both</option>
       <option value="1">Timesheet Records</option>
             <option value="active">Tome Off Records</option>
...
<h4 style="text-align: center; margin-top: 15px;"><b>Please Click On "Generate Report" Button On The Top Right Corner To See Your Report</b></h4>
